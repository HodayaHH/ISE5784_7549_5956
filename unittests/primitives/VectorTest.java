...
class VectorTest {
    ...
    void testScale() {
        ...
        assertEquals(v1,
                v.scale(2),
                "ERROR: scale() by 2 does not work correctly");

        //TC02:Multiply by a negative number
        assertEquals(v2,
                v.scale(-1),
                "ERROR: scale() by -1 does not work correctly");
    }
