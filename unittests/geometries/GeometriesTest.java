...
class GeometriesTest {
    ...
    void testFindIntersections() {
        ...
        assertNull(emptyGeometries.findGeoIntersectionsHelper(ray1),
        ...
        assertEquals(1, geometries.findGeoIntersectionsHelper(ray3).size(), "BVA: Ray should intersect with exactly one shape");
        ...
        assertEquals(3,
                geometries.findGeoIntersectionsHelper(ray5).size(),
